            ...
            modelBuilder.Entity("BestPractices.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateDate = new DateTime(2023, 8, 7, 10, 9, 32, 976, DateTimeKind.Local).AddTicks(8686),
                            Name = "Bilinmiyor 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 3,
                            CreateDate = new DateTime(2023, 8, 7, 10, 9, 32, 976, DateTimeKind.Local).AddTicks(8705),
                            Name = "Bilinmiyor 2",
                            Price = 10012m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreateDate = new DateTime(2023, 8, 7, 10, 9, 32, 976, DateTimeKind.Local).AddTicks(8709),
                            Name = "Bilinmiyor 3",
                            Price = 101240m,
                            Stock = 20
                        });
